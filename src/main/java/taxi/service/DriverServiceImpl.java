...
public class DriverServiceImpl implements DriverService {
    ...
    public Driver create(Driver driver) {
        ...
        if (checkIfBlank(driver)) {
            throw new RegistrationException("Entry data can't be empty");
        }
    ...
    private boolean checkIfBlank(Driver driver) {
        return driver.getName().isBlank()
                || driver.getLicenseNumber().isBlank()
                || driver.getLogin().isBlank()
                || driver.getPassword().isBlank();
    }
}
